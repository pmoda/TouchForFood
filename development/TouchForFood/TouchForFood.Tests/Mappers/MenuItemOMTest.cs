...
{
    /// <summary>
    ///This is a test class for MenuItemOMTest and is intended
    ///to contain all MenuItemOMTest Unit Tests
    ///</summary>
    [TestClass()]
    public class MenuItemOMTest
    {
        #region Fields
        ...
        #region Test Methods
        /// <summary>
        /// A test for delete method should return the # of items affected in the db
        ///</summary>
        [TestMethod()]
        ...
        /// <summary>
        ///Can only delete a menu item that is not active
        ///</summary>
        [TestMethod()]
